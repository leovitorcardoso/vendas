...
// Copy third party libraries from /node_modules into /plugins
gulp.task('plugins', function() {
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('./plugins/chart.js'))
    // DataTables
    gulp.src([
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('./plugins/jquery-easing'))
});
// Compile SCSS
...
// Default task
gulp.task('default', ['css', 'js', 'plugins']);
